...
```{r zemljevid_postelj, echo=FALSE, fig.align='center'}
zemljevid_postelj
```
```{r zemljevid_zivlj_dobe, echo=FALSE, fig.align='center'}
...
```{r zemljevid_cluster_zdr, echo=FALSE, fig.align='center'}
zemljevid_cluster_zdr
```
```{r zemljevid_cluster_razv, echo=FALSE, fig.align='center'}
